...
export enum FileFieldsEnum {
  ...
  ChildMarkdownRemarkFrontmatterColor = "childMarkdownRemark___frontmatter___color",
  ...
  ChildMarkdownRemarkFieldsYear = "childMarkdownRemark___fields___year",
...
export enum MarkdownRemarkFieldsEnum {
  ...
  FrontmatterColor = "frontmatter___color",
